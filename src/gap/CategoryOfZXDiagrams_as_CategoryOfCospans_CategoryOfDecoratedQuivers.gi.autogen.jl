      ...
      function ( cat, source, quadruple, range )
        ...
        @Assert( 0,
                ForAll( edges, edge ->
                        ...
                        PairGAP( decorations_of_vertices[1 + edge[1]], decorations_of_vertices[1 + edge[2]] ) ) ); # the edge [ 0, i ] has position i in S_ZX_EDGES
        ...
        central_decorated_quiver =
          ObjectConstructor( decorated_quivers,
                  PairGAP( Triple(
                          ...
                          nr_edges,
                          edges ),
                        PairGAP( decorations_of_vertices,
        ...
        input_morphism = MorphismConstructor( decorated_quivers,
                                  ...
                                  PairGAP( input_positions, CapJitTypedExpression( [ ], ( ) -> CapJitDataTypeOfListOf( IsBigInt ) ) ),
                                  central_decorated_quiver );
        
        output_morphism = MorphismConstructor( decorated_quivers,
                                   range_decorated_quiver,
                                   PairGAP( output_positions, CapJitTypedExpression( [ ], ( ) -> CapJitDataTypeOfListOf( IsBigInt ) ) ),
                                   central_decorated_quiver );
